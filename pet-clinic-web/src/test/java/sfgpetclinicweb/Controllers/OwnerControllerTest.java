...
class OwnerControllerTest {
    ...
    void setUp() {
        owners=new HashSet<>();
        owners.add(Owner.builder().id(1L).lastName("Kushwaha").build());
        owners.add(Owner.builder().id(2L).lastName("Kumar").build());
    ...
    void listOwners()throws Exception{
        when(ownerMapService.findAll()).thenReturn(owners);
    ...
    void findOwners()throws Exception{
        ...
        verifyZeroInteractions(ownerMapService);
    }
}